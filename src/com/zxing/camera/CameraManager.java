...
//			int a = supportedPreviewSizes.get(3).width;
//			int b =  supportedPreviewSizes.get(3).height;
//			parameters.setPreviewSize(a,b);
//			a = supportedPictureSizes.get(0).width;
//			b =  supportedPictureSizes.get(0).height;
